...
public class ShipDataEnhancementService {
        ...
        public void processAndDeleteShipData(ShipDataEnhancementId shipDataId) { // Changed parameter to
                ...
                deletedDataRepresentation.setDescription(
                                "Provenance record for deleted ShipDataEnhancement, original ID: "
                                                + originalRecordIdentifier);
                ...
                deletionActivity.setId(UUID.randomUUID().toString()); // REMOVED: ID is now
        ...
        public void processAndApproveShipData(ShipDataEnhancementId shipDataId) {
                ...
                approvedDataRepresentation.setDescription(
                                "Provenance record for approved ShipDataEnhancement, original ID: "
                                                + originalRecordIdentifier);
                ...
                approvedDataRepresentation.setResourcePath("PRJ_LEI_2025.dbo.ShipDataEnhancement4"
                                + originalRecordIdentifier.replace(",", "_").replace(":", "-"));
                ...
                approvalActivity.setDescription(
                                "Approval of ShipDataEnhancement record (original ID: " + originalRecordIdentifier
                                                + ")"); // Changed
                                                        // description
